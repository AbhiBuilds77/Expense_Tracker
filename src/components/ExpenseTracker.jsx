  ...
  return (
    <div className='min-h-screen p-6 bg-bg text-text transition-colors'>
      ...
      <div className='card mx-auto mt-6 max-w-md'>
        ...
        <input value={description} onChange={(e)=>setDescription(e.target.value)} type="text" placeholder='description' className='px-3 py-2 border rounded ml-2'></input>
        <button onClick={addExpense} className='btn  w-[140px] ml-[140px]'>Add</button>
      </div>
